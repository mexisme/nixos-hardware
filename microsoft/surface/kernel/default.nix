...
let
  ...
  surface_kernelPatches = {
    ...
    linux_5_9 = [
      ...
      }
      {
        ...
        patch = patches + "/5.4/0007-surface-hotplug.patch";
      }
      {
        name = "ms-surface/0008-surface-typecover";
        patch = patches + "/5.4/0008-surface-typecover.patch";
      }
    ];
  ...
  surface_kernelPackages = {
    ...
    linux_5_10_2 = (with pkgs; recurseIntoAttrs (linuxPackagesFor (
      callPackage ./linux-5.10.2.nix {
        kernelPatches = surface_kernelPatches.linux_5_10_2;
      }
    )));

    linux_5_10_4 = (with pkgs; recurseIntoAttrs (linuxPackagesFor (
      callPackage ./linux-5.10.4.nix {
        kernelPatches = surface_kernelPatches.linux_5_10_4;
      }
    )));
  };
in {
