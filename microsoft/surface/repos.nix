{ lib, pkgs, fetchGit, ... }:
{
  linux-surface = fetchGit {
    url="git@github.com:linux-surface/linux-surface.git";
  ...
  surface-ipts-firmware = fetchGit {
    url="git@github.com:linux-surface/surface-ipts-firmware.git";
  ...
  libwacom-surface = fetchGit {
    url="git@github.com:linux-surface/libwacom-surface.git";
